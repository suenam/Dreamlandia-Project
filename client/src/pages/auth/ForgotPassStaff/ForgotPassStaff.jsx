...
const ForgotPassStaff = () => {
  ...
  const handleSubmitReset = async (event) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/reset-staff-password`, {
        method: 'PUT',
        headers: {
...
export default ForgotPassStaff;